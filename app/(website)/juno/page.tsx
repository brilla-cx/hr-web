...
const Juno: React.FC = (): ReactElement => {
    return (
        <>
            ...
            <div className="bg-midnight px-6 py-24 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-400">
                        Juno is the AI assistant for Hey Rebekah's tech stack. She was super hungry for knowledge, so she ingested everything there is to know about Next.js, Sanity.io, Tailwind CSS, TypeScript, Vercel, GitHub, PNPM, and more.
                    </p>
                    <p className="mt-6 text-lg leading-8 text-gray-400">
            ...
            <div className="min-h-screen mt-2 bg-gray-100 flex items-start justify-center overflow-y-hidden">
                <div
                    id="libraria-widget"
