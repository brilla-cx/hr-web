...
const nextConfig = {
  ...
  async headers() {
    const ContentSecurityPolicy = `
      ...
      frame-ancestors 'self' http://localhost:3000 http://localhost:3333 https://hr-web-beta.vercel.app/;
    `;
