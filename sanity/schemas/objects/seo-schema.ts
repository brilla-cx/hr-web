...
const seo = {
    ...
    fields: [
        ...
        },
        {
            ...
            options: { spellCheck: true, max: 58 },
            validation: Rule => Rule.required().error("Please add an SEO optimized Title."),
        },
        {
            name: 'seoDescription',
            ...
            options: { spellCheck: true, max: 58 },
            validation: Rule => Rule.required().error("Please add an SEO optimized description."),
