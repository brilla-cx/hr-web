    ...
    <div className="flex gap-2 items-center">
      <WhatsappShareButton
        ...
        <svg
          ...
          <desc id="whatsappDesc">
            A WhatsApp icon that is a button to share the Hey Rebekah post via
            WhatsApp.
          </desc>
      ...
      <TwitterShareButton
        ...
        <svg
          ...
          aria-describedby="twitterDesc">
          <desc id="twitterDesc">
            A Twitter icon that is a button to share the Hey Rebekah post via
            Twitter.
          </desc>
      ...
      <FacebookShareButton quote={title} hashtag="#heyrebekah" url={url}>
        <svg
          ...
          <desc id="facebookDesc">
            A Facebook icon that is a button to share the Hey Rebekah post via
            Facebook.
          </desc>
      ...
      <RedditShareButton title={title} url={url}>
        <svg
          ...
          <desc id="redditDesc">
            A Reddit icon that is a button to share the Hey Rebekah post via
            Reddit.
          </desc>
      ...
      <EmailShareButton
        ...
        <svg
          ...
          <desc id="emailDesc">
            An email icon that is a button to share the Hey Rebekah post via
            email.
          </desc>
