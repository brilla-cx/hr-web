  ...
  return (
    <div className="flex gap-2 items-center">
      <WhatsappShareButton
        ...
        url={url}>
        <svg
          className="transition-all duration-200 ease-in-out transform hover:rotate-10 fill-current text-gray-200 hover:text-pink-500"
          viewBox="0 0 64 64"
          width="32"
          height="32"
          aria-label="Share on WhatsApp"
          aria-describedby="whatsappDesc">
          <desc id="whatsappDesc">
            A WhatsApp icon that is a share button to share the webpage via
            WhatsApp.
          </desc>
      ...
      <LinkedinShareButton
        ...
        url={url}>
        <svg
          className="transition-all duration-200 ease-in-out transform hover:scale-110 fill-current text-gray-200 hover:text-pink"
          viewBox="0 0 64 64"
          width="32"
          height="32"
          ...
          <desc id="twitterDesc">
            A LinkedIn icon that is a share button to share the webpage via
            LinkedIn.
          </desc>
      ...
      <TwitterShareButton
        ...
        <svg
          ...
          aria-describedby="twitterDesc">
          <desc id="twitterDesc">
            A Twitter icon that is a share button to share the webpage via
            Twitter.
          </desc>
      ...
      <FacebookShareButton quote={title} hashtag="#heyrebekah" url={url}>
        <svg
          ...
          aria-describedby="facebookDesc">
          <desc id="facebookDesc">
            A Facebook icon that is a share button to share the webpage via
            Facebook.
          </desc>
      ...
      <RedditShareButton title={title} url={url}>
        <svg
          ...
          aria-describedby="redditDesc">
          <desc id="redditDesc">
            A Reddit icon that is a share button to share the webpage via
            Reddit.
          </desc>
      ...
      <EmailShareButton
        ...
        <svg
          ...
          <desc id="emailDesc">
            An email icon that is a share button to share the webpage via email.
          </desc>
