// T-11871 Refactor GlowingButtons
...
const GradientBackground: React.FC = () => {
  ...
  const gradientBackgroundClasses = cx(
    "absolute -inset-px rounded bg-gradient-to-r from-blue-900 to-violet-900 blur-sm transition-all duration-1000 group-hover:-inset-1 group-hover:opacity-100 group-hover:duration-200"
  );
...
interface GlowingButtonLightProps {
...
// Main component for the glowing button
const GlowingButtonLight: React.FC<GlowingButtonLightProps> = ({
  variant = null,
  href = "",
  size = "md",
  children,
...
export default GlowingButtonLight;
