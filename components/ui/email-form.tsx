...
function EmailForm() {
  return (
    <div className="grid grid-cols-1 gap-6 px-0 gap-y-10 pb-36 md:grid-cols-2 md:px-24 lg:grid-cols-2 lg:px-28">
      <H3 className="col-span-2 font-bold text-center text-gray-200">
        Together with Hey Rebekah
      </H3>
      <Lead className="max-w-lg col-span-2 pb-6 mx-auto text-center text-gray-200">
      ...
      />
      <div className="col-span-2 pt-6 mx-auto">
        <GlowingButton
          variant="link"
