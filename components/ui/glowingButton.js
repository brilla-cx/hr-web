...
const GradientBackground = () => {
  ...
  const gradientBackgroundClasses = cx(
    "absolute transition-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-[#ff00fe] to-amber-600 blur-sm md:blur rounded group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200"
  );
