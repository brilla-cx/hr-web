    ...
    <main className="grid min-h-[75vh] place-items-center bg-midnight px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/"
            className="rounded border border-gray-200/10 px-3.5 py-2.5 text-sm font-semibold text-gray-200 transition-all duration-200 ease-in-out hover:bg-slate-800 hover:text-white">
            Go to Home page
          </Link>
          <Link
            href="/contact"
            className={cx("text-sm font-semibold text-gray-400", hoverStyles)}>
